...
export const ClientNotificationTemplate = () => {
    ...
    const fetchTutor = async () => {
        try {
            ...
            const filteredTutors = response.data.filter(tutor => tutor.user_type === 'client' && tutor.status === 'active');
    ...
    return (
        <div className="">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-2 ms-2">
