...
export function ClientNotificationPages() {
  ...
  const handleAddEvent = async () => {
    try {
    const data = { ...newEvent, user_type: "client" };
  ...
  const handleSendNotification = (id) => {
     navigate('/dashboard/client/notification/template', { state: { id } });           
